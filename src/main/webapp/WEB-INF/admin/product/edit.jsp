...
<h3>EDIT PRODUCT</h3>
<s:form modelAttribute="product" action="/admin/product/edit/${product.id}" method="post" enctype="multipart/form-data">
	...
	Picture 2:
		...
		<s:input path="file" type="file" /> | <a href="/admin/product/${id}/remove/image/1">Remove</a><br> 
	Picture 3:
		<img src="${picture2 }" width=50 alt="No Image">
		<s:input path="file" type="file" /> | <a href="/admin/product/${id}/remove/image/2">Remove</a><br> 
	Picture 4:
		<img src="${picture3 }" width=50 alt="No Image">
		<s:input path="file" type="file" /> | <a href="/admin/product/${id}/remove/image/3">Remove</a><br> 
	Picture 5;
		<img src="${picture4}" width=50 alt="No Image">
		<s:input path="file" type="file" /> | <a href="/admin/product/${id}/remove/image/4">Remove</a><br> 
	Picture 6:
		<img src="${picture5}" width=50 alt="No Image">
		<s:input path="file" type="file" /> | <a href="/admin/product/${id}/remove/image/5">Remove</a><br> 
	Picture 7:
		<img src="${picture6}" width=50 alt="No Image">
		<s:input path="file" type="file" /> | <a href="/admin/product/${id}/remove/image/6">Remove</a><br> 
	Picture 8:
		<img src="${picture7}" width=50 alt="No Image">
		<s:input path="file" type="file" /> | <a href="/admin/product/${id}/remove/image/7">Remove</a><br>
	<s:hidden path="id"/><br> 
