...
<section id="content">
	<div class="content-page">
		<div class="banner-slider banner-slider-v1">
			<div class="wrap-item" data-pagination="false" data-autoplay="true"
				data-transition="fade" data-navigation="true"
							...
							<div class="featured-item">
								<div class="info-box">
									<div class="title-box title-featured">
										...
										<h2 class="title30 text-uppercase rale-font">
											<span>glasses</span>
										</h2>
		...
		<div class="box-theshop text-center bg-white">
			<div class="container">
				<div class="title-box">
					...
					<h3 class="title14 text-uppercase font-bold">MOST-COVETED
						CLOTHING</h3>
				</div>
				<ul class="nav nav-tabs list-inline-block" roles="tablist">
					<li roles="presentation" class="active"><h3>
							<a href="#tab1" class="text-uppercase title12 shop-button"
								data-toggle="tab">new arrivals</a>
						</h3></li>
					<li roles="presentation"><h3>
							<a href="#tab2" class="text-uppercase title12 shop-button"
								data-toggle="tab">latest products</a>
						</h3></li>
					<li roles="presentation"><h3>
							<a href="#tab3" class="text-uppercase title12 shop-button"
								data-toggle="tab">best sellers</a>
						</h3></li>
					<li roles="presentation"><h3>
							<a href="#tab4" class="text-uppercase title12 shop-button"
								data-toggle="tab">on sale</a>
						</h3></li>
				</ul>
				<div class="content-box">
					<div class="tab-content">
						<div id="tab1" class="tab-pane fade in active wrap-product"
							roles="tabpanel">
						...
						<div id="tab2" class="tab-pane fade in wrap-product"
							roles="tabpanel">
							<div class="wrap-item" data-pagination="false"
								data-autoplay="false" data-transition="fade"
								data-navigation="true"
						...
						<div id="tab3" class="tab-pane fade in wrap-product"
							roles="tabpanel">
							<div class="wrap-item" data-pagination="false"
								data-autoplay="false" data-transition="fade"
								data-navigation="true"
						...
						<div id="tab4" class="tab-pane fade in wrap-product"
							roles="tabpanel">
							<div class="wrap-item" data-pagination="false"
								data-autoplay="false" data-transition="fade"
								data-navigation="true"
					...
					<div class="row">
						<div class="col-md-6">
							<div class="item-advs item-advs1 bg-white">
								<div
									class="advs-info advs-info-shoes advs-info-left text-center ">
		...
		<div class="our-blog bg-gray text-center">
			<div class="container">
				<div class="title-box">
					...
					<h3 class="title14 text-uppercase font-bold">timely update
						fashion trends of the world</h3>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-4">
						<div class="post-item">
		...
		<div class="box-deal bg-white">
			<div class="container">
				<div class="title-box">
					...
					<h3 class="title14 text-uppercase font-bold">Check out our
						loving products today</h3>
				</div>
				<div class="wrap-item" data-pagination="false" data-autoplay="false"
							...
							<div class="col-md-6 col-sm-6">
								<div class="item-product table border">
									...
									<div class="product-info">
										...
										<div class="deal-clock time-countdown" data-date="12/12/2019"
		...
		<div class="box-customers bg-gray">
			<div class="container">
				<div class="title-box">
					...
					<h3 class="title14 text-uppercase font-bold">You’ve got to
						expect thousands of nice reviews!</h3>
				</div>
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="item-customer">
							<p class="desc text-italic title18 bg-white">I have a thing
								for sunglasses, like I do indeed collect these and I have a real
								big range of it at home. Luckily, stores like this one let me
					...
					<div class="col-md-6 col-sm-6">
						<div class="item-customer">
							<p class="desc text-italic title18 bg-white">I was always a
								big shopper, especially when it comes to either apparel or even
								accessories. Are these sunglasses, jewelry or purses – I need it
								all!</p>
							<div class="box-avatar table">
								<div class="thumb-box">
									<a href="#" class="advs-thumb-link"><img
