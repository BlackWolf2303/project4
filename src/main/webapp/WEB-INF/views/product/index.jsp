				...
				<div class="row">
						...
						<div class="box-detail-product box-detail-sidebar">
							<div class="wrap-detail-product wrap-detail-product3 border">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="detail-gallery detail-gallery3">
											...
											<div class="gallery-control gallery-control3">
												...
												<div
													class="control-button-gallery control-button-gallery3 text-center">
								...
								<ul class="list-inline-block box-btn box-btn2">
									<li><a href="#" class="detail-btn btn-left"><i
											class="fas fa-angle-left"></i></a></li>
									<li><a href="#" class="detail-btn btn-right"><i
							...
							<div class="title-tab-detail">
								<ul class="list-inline-block">
									<li class="active"><a href="#tab1" data-toggle="tab"
										class="link-hover text-uppercase font-bold">Description</a></li>
									<li><a href="#tab2"
										class="text-uppercase font-bold link-hover" data-toggle="tab">Reviews</a></li>
									<li><a href="#tab3"
										class="text-uppercase font-bold link-hover" data-toggle="tab">tags</a></li>
									<li><a href="#tab4"
										class="text-uppercase font-bold link-hover" data-toggle="tab">video</a></li>
								</ul>
							</div>
											...
											<div class="col-md-3 col-sm-4 col-xs-4">
												<div class="thumb-box overlay-image">
													<a href="#" class="advs-thumb-link"><img
														src="${pageContext.request.contextPath}/resources/assets/photos/clothing/fashion-33.jpg"
														alt="" /></a>
												</div>
											</div>
											<div class="col-md-9col-sm-8 col-xs-8">
												<div class="info-box">
													<p class="desc">Our planet is something unbelievable.
														It is so diverse and beautiful, so unique and
														controversial. Earth is worth our admiring. The easiest
														way to explore all wonders and unique places of our planet
														is travelling. It is very romantic and it takes one's
														breath away because new emotions are always unforgettable.
														Just imagine yourself standing on the top of the waterfall
														or sitting among the tropical plants in the jungles. All
														these world wonders such as endless deserts, boiling
														volcanoes, icebergs and other phenomena are available for
														you to see with your own eyes. The words are not enough to
														express all your emotions. But travelling is very
														complicated activity that is why you must be prepared to
														any kinds of surprises. In ancient times travellers have
														used maps as the main source of information. The globe and
														the map are the small model of our world. Nowadays maps
														are very useful thing especially when you want to explore
														some wild spots. Of course you can rely on your GPS system
														but we must never forget our past because new technologies
														are more vulnerable than good-old stuff. Our company
														provides goods of premium quality and at fair prices. We
														are sure that these options are the secret of success.
														That is why we have so many devoted clients all over the
														country - there is nothing better than thankful customers.
														Our products are the inspiration to save the nature and
														explore new spaces. We care about clients and we hope that
														our products will suit you in the best way. If you have
														some questions you can find the answers in our superb 24/7
														support system. Don’t forget about our special discounts
														and benefits.</p>
													<ul class="list-none">
														<li>The globe and the map are the small model of our
															world. Nowadays maps are very useful thing especially
															when you want to explore some wild spots.</li>
														<li>Of course you can rely on your GPS system but we
															must never forget our past because new technologies are
															more vulnerable than good-old stuff.</li>
													</ul>
												</div>
											</div>
										</div>
								...
								<div id="tab2" class="tab-pane">
									<div class="content-review">
										<div class="box-thought">
											<h3 class="title18 text-uppercase font-bold">2 review ON
												“A SIMPLE BLOG POST”</h3>
											<div class="author-thought table first-child">
												<div class="ava-author">
													<a href="#"><img
														src="${pageContext.request.contextPath}/resources/assets/photos/ava-post/02.png"
														alt="" /></a>
												</div>
												<div class="content-box">
													<div class="name-author clearfix">
														<h3 class="title14 text-uppercase font-bold pull-left">Mr
															Amson says:</h3>
														<a href="#"
															class="link-hover link-rep font-semi-bold text-uppercase pull-right">reply</a>
													</div>
													<p class="desc">Hi, this is a comment.</p>
													<p class="desc">To delete a comment, just log in and
														view the post's comments. There you will have the option
														to edit or delete them.</p>
													<a href="#" class="link-hover title12 silver">Feb 26,
														2017 </a>
												</div>
											</div>
											<div class="author-thought table">
												<div class="ava-author">
													<a href="#"><img
														src="${pageContext.request.contextPath}/resources/assets/photos/ava-post/03.png"
														alt="" /></a>
												</div>
												<div class="content-box">
													<div class="name-author clearfix">
													...
													<p class="desc">To delete a review, just log in and
														view the post's comments. There you will have the option
														to edit or delete them.</p>
													<a href="#" class="link-hover title12 silver">Feb 26,
														2017 </a>
										...
										<div class="box-rep-comment">
											<h3 class="title18 text-uppercase font-bold">add a
												review</h3>
											<p class="desc">Your email address will not be published.
									...
									<div class="detail-video">
										<div class="box-player">
											<div class="video-info">
												<a href="#" class="video-button shop-button"> discover
													now</a>
											</div>
											<video class="video-custom" loop muted
												poster="photos/banner/7uptheme_verycheap_50.jpg">
												<source src="video/video_verycheap_fashion.mp4"
													type="video/mp4">
											</video>
										</div>
									</div>
						...
						<div class="lastest-product">
							...
							<div class="wrap-product">
								<div class="wrap-item" data-pagination="false"
									data-autoplay="false" data-transition="fade"
									data-navigation="true"
									data-itemscustom="[[0,1],[560,2],[768,3],[1024,3],[1200,3]]">
					...
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="sidebar-right">
							<div
								class="widget widget-rate-product widget-rate-product2 bg-white border">
								<h2 class="widget-title title14 text-uppercase font-bold">TOP
									RATED PRODUCTS</h2>
								<ul class="list-none">
									<li>
										<div class="item-product table">
											<div
												class="product-thumb text-center zoom-rotate overlay-image">
												<a href="#" class="advs-thumb-link"><img
											...
											<div class="product-info">
												...
												<ul class="list-inline-block product-price">
													<li><del>$97.00</del> <ins class="font-bold color">$48.50</ins>
													</li>
												</ul>
											</div>
										</div>
							...
							<div class="widget6 widget-banner zoom-rotate overlay-image">
								<a href="#" class="advs-thumb-link"><img
									src="${pageContext.request.contextPath}/resources/assets/photos/banner/7uptheme_verycheap_25.jpg"
									alt="" /></a>
							</div>
						</div>
					</div>
