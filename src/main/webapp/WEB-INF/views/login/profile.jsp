				...
				<div class="main-content-page">
					<div class="content-contact-page contact-form-faq">
						...
						<div class="contact-form profile-page">
							<s:form action="/profile" method="POST" modelAttribute="account" enctype="multipart/form-data">
								<table>
									...
									<tr>
										...
										<td>
											...
											<a href="/profile/avatar/remove">Remove</a>
										</td>
									...
									<tr>
										<td colspan='2'><input type="submit" value="submit" class="bg-color white text-uppercase font-bold"/></td>
										<s:hidden path="id" />
									</tr>
								</table>
							</s:form>
